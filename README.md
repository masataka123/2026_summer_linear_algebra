...
- 担当は岩井雅崇(いわいまさたか)です.
- この授業は対面授業+演義です. 木曜2(10:30-12:00)に対面授業を行い, 3限(13:30-15:00) に演義を行います. 場所は??です. 講義だけでなく授業資料や教科書を活用して線形代数の理解を深めてください.
...
# 成績に関して
成績は次の三つでつけます
- 期末試験(後述) 成績の大部分(80%前後)を占めます. 
- 中間テスト(後述) 成績の(20%前後)を占めます. ただし中間テストができなかった場合でも期末試験で挽回できるようにするので, 最後まで諦めないでください. 
- 演義での小テスト. これはほとんど成績に関与しませんが, 保険や成績のグレードが上がる可能性があります. 例えば58点不可が60点可になったり, 79点が80点に上がるなどです. 

成績に関しての注意点は以下のとおりです. 
- 通常時の授業に出席点はございません. よって授業への出席は任意となります. 
- 演義に関しても出席点はないですが. 出席した方がいいです. 
- 単位を認定するくらいの成績が取れていない場合, 容赦無く不可を出します. ただし追試験はするつもりです. 理由は「線形代数ができないとその後の数学の授業についていけない」からです. 
...
- 日時: 2026年〇〇月〇〇日(予定) 木曜3限(13:30-12:00)  13:15までには着席してください.
- 場所: 〇〇 (授業の部屋)
- 持ち込みに関して:  無し
- 試験内容: 授業でやった範囲
...
[ガイダンス資料+授業資料](https://masataka123.github.io/2026_summer_linear_algebra/material/0_線形代数_2025.pdf)
